...
| Colorida | Cinza (0–255) | Binarizada (0 e 255) |
|----------|---------------|-----------------------|
| ![colorida](docs/colorida.png) | ![cinza](docs/cinza.png) | ![binaria](docs/binaria.png) |

*(As imagens acima são ilustrativas, substitua por prints reais do seu Colab se desejar)*
